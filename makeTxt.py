...
def get_details(txt_name):
    ...
    for box,obj in zip(boxes,objects):
        plt.plot([box[0],box[2]],[box[1],box[1]],color='r')
        plt.plot([box[0],box[0]],[box[1],box[3]],color='r')
        plt.plot([box[0],box[2]],[box[3],box[3]],color='r')
        plt.plot([box[2],box[2]],[box[1],box[3]],color='r')
        plt.text(box[0], box[1], obj,size=12,color = 'r')
